...
// Command     : write_verilog -force -mode synth_stub -rename_top fused_mul -prefix
//               fused_mul_ floating_point_0_stub.v
...
module fused_mul(aclk, aresetn, s_axis_a_tvalid, s_axis_a_tdata, 
