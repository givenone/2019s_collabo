...
#
# Generated by Vivado on Mon Jun 15 01:35:32 +0900 2020
...
simulate()
{
  xsim floating_point_0 -key {Behavioral:sim_1:Functional:floating_point_0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
