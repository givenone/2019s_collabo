...
HD_PWD='C:/Users/yeap98/Desktop/4-1/lab/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_sec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_sec.tcl
