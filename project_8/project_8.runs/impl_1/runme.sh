...
HD_PWD='C:/Users/yeap98/Desktop/4-1/lab/project_8/project_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log one_sec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source one_sec.tcl -notrace
